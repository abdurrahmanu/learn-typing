<template>
    <div :class="appTheme" class="min-h-[200px] text-center cursor-default result">
        <div class="flex w-fit m-auto gap-x-4">
            <p class="py-1 text-xl text-center text-slate-500 stats">STATISTICS</p>
        ...
        <div class="w-fit p-[1px] hover:bg-gradient-to-tr transition-all duration-500 rounded-md m-auto py-3">            
            <div class="flex justify-center p-3 m-auto border border-transparent  text-[15px] rounded-md w-fit hover:border-zinc-600">
