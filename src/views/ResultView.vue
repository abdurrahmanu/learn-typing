    ...
    <div :class="appTheme" class="min-h-[200px] text-center xl:pt-20 cursor-default">
        ...
        <div class="flex py-1 m-auto gap-x-2 w-fit text-slate-300">            
            ...
            <div class="relative w-fit">                
                ...
                <div :class="[difficulty === 'beginner' ? 'bg-teal-700' : difficulty === 'amateur' ? 'bg-green-500' : difficulty === 'expert' ? 'bg-amber-700' : '']" class="absolute rounded-md top-[115%] right-0 z-[1] text-left p-1 hidden peer-hover:block shadow-sm shadow-black text-[13px]">
