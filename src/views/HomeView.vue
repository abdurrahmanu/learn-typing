<template>
    <div  class="m-auto max-w-[1500px] lg:flex"> 
      <div class="w-[100%] mx-auto flex-none space-y-3">   
        <div @click="hideElements = !hideElements" v-if="hideElements" :class="!hideElements ? '' : ''" class="p-1 px-2 cursor-pointer font-[500] rounded-md m-auto text-[14px] uppercase border border-slate-500 whitespace-nowrap w-fit hover:border-green-400 relative z-[1]">quick settings </div>   
