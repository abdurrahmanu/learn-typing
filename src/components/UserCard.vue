<template>
  <div
    class="w-[95%] max-w-[1000px] bg-white shadow-xl rounded-2xl p-6 md:p-8 mx-auto flex flex-col gap-6 transition-all duration-300"
  >
    ...
    <div v-else>
      <div class="flex justify-between">
        ...
        <p
          @click="logout"
          class="flex items-center justify-center gap-3 px-10 py-1 font-medium border rounded-md cursor-pointer border-neutral-600 hover:text-white hover:bg-red-300"
        >
          LOGOUT
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-center">
        ...
        <div class="bg-neutral-100 p-4 rounded-xl col-span-2 sm:col-span-1">
          <p class="text-2xl font-bold text-black">
            {{ Math.round(userInfo.secondsTyped % 60).toFixed(2) }}
          </p>
