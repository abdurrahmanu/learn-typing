<template>
    ...
    <Transition name="zoom">
        <div v-if="showCookiesModal" class="fixed p-3 m-auto rounded-sm w-[500px] max-w-[90%] bg-black text-slate-300 space-y-3 text-sm left-[50%] translate-x-[-50%] z-[9999] top-[40%] translate-y-[-50%] rounded-br-[20px]">
