<template>
<div ref="containerEl" :class="[isMobileOS() && focus ? 'hidden' : 'block']" class="m-auto rounded-md w-fit relative max-w-[90%] bg-inherit text-[11px] config min-w-[300px] font-semibold">
    ...
    <Transition name="alphabet">
      <div v-if="!hasCompletedSession && mode === 'alphabets'" :class="[appTheme]" class="rounded-md w-[90%] min-w-fit m-auto max-w-fit ring-1 ring-green-700 relative py-1 px-10">
