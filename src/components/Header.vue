<template>
    <header class="sticky mx-auto flex items-center justify-between pl-3 pr-2 max-w-[1500px] lg:mb-6 mb-3 min-[1350px]:fixed min-[1350px]:w-full text-[11px] uppercase font-medium z-[1] min-w-[360px]" :class="[focus && (hideElements && isMobileOS()) ? 'h-0 p-0 mb-0' : 'pb-2 h-[50px]']">
