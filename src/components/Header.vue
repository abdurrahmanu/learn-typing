<template>
    <nav :class="[appTheme]" class="sticky top-0 left-0 flex items-center justify-between py-2 pl-3 pr-2 h-[50px] shadow-sm shadow-black max-w-[1300px] m-auto mb-3 z-[2] xl:fixed lg:w-full">
