<template>
    <nav :class="[appTheme]" class="sticky top-0 mx-auto flex items-center justify-between py-2 pl-3 pr-2 h-[50px] shadow-sm shadow-black max-w-[1300px] mb-3 z-[2] xl:fixed">
