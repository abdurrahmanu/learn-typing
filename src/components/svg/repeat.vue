...
const alphabet = alphabetsStore()
const { alphabetsMode_ } = storeToRefs(alphabet)

const theme_ = themeStore()
const { svgFill, theme } = storeToRefs(theme_)
</script>
