    ...
    <div>
      <div v-if="!saveCustomText" class="space-y-1 text-center">
        ...
        <div class="relative w-[90%] m-auto">
          ...
          <textarea
            v-model="textValue"
            class="w-full bg-inherit h-40 p-2 pt-2 border rounded-md outline-none border-slate-500"
    ...
    <div class="max-w-[90%] m-auto">
      ...
      <div class="max-h-[calc(100dvh_-_50dvh)] overflow-y-auto h-fit p-2">
        <div class="relative overflow-y-auto space-y-[5px]">
          <div
            v-for="(test, key, index) in customQuotes"
            :key="index"
...
const { customChoice, settingsToUpdate, customQuotes, toggleCustomModal } =
