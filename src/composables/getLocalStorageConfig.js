...
export const localStorageConfig = async () => {
    ...
    const {showCookiesModal, useCookies} = storeToRefs(cookies)
    ...
    if (localStorage.getItem('kiboardcookies') === null) showCookiesModal.value = true

    if (localStorage.getItem('kiboardcookies')) {
        if (localStorage.getItem('kiboardcookies') === 'yes') {
            ...
            if (localStorage.getItem('kiboard')) {
                ...
                let dorayiTypingObject = {
                    ...
                    alphabetsCombo: localStorageSettings.value.alphabetsCombo || false,
                    alphabetsCombination: localStorageSettings.value.alphabetsCombination ||  [],
                }
                ...
                if (localStorageSettings.value.alphabetsCombo) {
                    useAlphabetCombination.value = true
                    alphabetsCombination.value = localStorageSettings.value.alphabetsCombination || []
                }
            }
