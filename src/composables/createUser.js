export const createUser = (user) => {
  ...
  return {
    ...
    customTests: {
      demo: "This is a custom test, you can add your own tests by pressing the plus icon. This demo test cannot be deleted",
    },
    customWords: { demo1: "messi", demo2: "cr7" },
    customQuotes: {
      demo: "This is a custom quote, you can add your own tests by pressing the plus icon. This demo test cannot be deleted",
    },
